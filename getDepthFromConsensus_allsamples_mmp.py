...
def runBamReadCount():
    ...
    # bamheader = pipe.read()
    fastaFile = "/proj/omics4tb/sturkarslan/singleCell-UA3-mmp/reference/Methanococcus_maripaludis_s2.GCA_000011585.1.30.dna.genome.fasta"
    # file to get list of all variants in all single cells
    variantFile = "/proj/omics4tb/sturkarslan/singleCell-UA3-mmp/mmp-UA3-03and09-Final-Merged-Variant-2morecells_80percent-bed.txt"
...
paths = ["/proj/omics4tb/sturkarslan/singleCell-UA3-mmp/results-UA3-152-03/mmp/*_Mmp_*/", "/proj/omics4tb/sturkarslan/singleCell-UA3-mmp/results-UA3-152-09/mmp/*_Mmp_*/"]
